...
export const RELEASE_FEED_URL = `https://github.com/${RELEASE_REPOSITORY}/releases/latest/download/${RELEASE_MANIFEST_ASSET_NAME}`;
/**
 ...
 */
export function releaseManifestUrl(options = {}) {
