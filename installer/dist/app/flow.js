...
export class InstallFlow {
    ...
    async detect() {
        ...
        return this.inspectChosen(installs[0]);
    }
    async inspectChosen(install) {
        ...
        if (installState.kind === "patched-by-other") {
            ...
            if (installState.mod === "betterdiscord") {
                ...
                return this.set(state({
                    ...
                    detail: "BetterDiscord is installed. Subline cannot work alongside it: BetterDiscord replaces the folder "
            ...
            return this.set(state({
                step: "mod-conflict",
                detail: `${installState.modName ?? "Another client mod"} is already installed in this Discord. `
    ...
    async waitForPermission() {
        ...
        return this.set(state({
            ...
            detail: `${report.summary} Without it, Subline cannot add translation to Discord — everything else you have `
    ...
    async launch() {
        ...
        if (!launched.ok) {
            ...
            return this.set(state({
                step: "launch-failed",
                detail: `${launched.error.message} Subline is installed — open Discord yourself and Subline will check whether `
