 ...
 */
export const REDACTED_FIELD_KEYS = [
    "text",
    "content",
    "body",
    "message",
 ...
 */
export function redactField(key, value) {
...
export function formatEntry(at, level, event, fields) {
...
export class DiagnosticsLog {
    ...
    rotateIfNeeded(incomingBytes) {
        ...
        for (let generation = this.maxFiles - 1; generation >= 1; generation -= 1) {
            ...
            if (existsSync(from))
                renameSync(from, this.rotatedPath(generation + 1));
        }
